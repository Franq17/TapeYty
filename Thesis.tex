...
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter2/chapter2} % Mejora de imagen 

\clearpage
\lhead{\emph{Sistemas de Información Geográfica}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter3/chapter3} % Optimización PSO
...
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter5/chapter5} % Planteamiento del problema

\clearpage
\lhead{\emph{Aplicación TapeYty}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter6/chapter6} % Solución propuesta

\clearpage
\lhead{\emph{Resultados y Discusión}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter7/chapter7} % Resultados y Discusión

\clearpage
\lhead{\emph{Conclusión}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Conclusion/conclusion} % Conclusión
...
\input{AppendixA/appendixA}	% Appendix Title


\lhead{\emph{Apéndice B}} 
\renewcommand{\appendixname}{Apéndice}
\input{AppendixB/appendixB} % Appendix Title

\lhead{\emph{Apéndice C}} 
\renewcommand{\appendixname}{Apéndice}
\input{AppendixC/appendixC} % Appendix Title

\backmatter
%% --------------- Referencias ------------------------------------

\renewcommand{\bibname}{Bibliografía}
\bibliography{References/referencias_tapeyty}
