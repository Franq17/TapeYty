...
\clearpage
\lhead{\emph{Métricas de Evaluación}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter4/chapter4} % Métricas de evaluación

\clearpage
\lhead{\emph{Propuesta}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter5/chapter5} % Propuesta

\clearpage
\lhead{\emph{Resultados y Discusión}} 
\renewcommand\chaptername{Capítulo}%título "Capítulo"
\input{Chapter6/chapter6} % Resultados y Discusión
