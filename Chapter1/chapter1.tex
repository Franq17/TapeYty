...
\begin{table}[tbp]
\caption{Resumen de los enfoques de optimización de la recolección de residuos sólidos. [Fuente: \citet{Sulemana2018OptimalMethods}]}
\label{table:resumenEnfoquesOptimizacion}
\resizebox{\textwidth}{!}{%
\begin{tabular}{lc}
\hline
\multicolumn{1}{c}{Enfoque} & Fortalezas y debilidades                                                                                                                                                       \\ \hline
(a) Programación matemática & \textit{Fortalezas}                                                                                                                                                            \\
                            & (1) Diferentes tipos de VRP son resueltos usando algoritmos matemáticos.                                                                                                       \\
                            & (2) Busca maximizar/minimizar una función objetivo.                                                                                                                            \\
                            & (3) Utilizado para mejorar el procedimiento.                                                                                                                                   \\
                            & (4) Asegura la eficiencia operativa.                                                                                                                                           \\
                            & (5) Usado como herramienta de soporte de decisión.                                                                                                                             \\
                            & \textit{Debilidades}                                                                                                                                                           \\
                            & (1) Proporciona solución parcial cuando se aplica en la realidad.                                                                                                              \\
                            & \begin{tabular}[c]{@{}c@{}}(2) No puede manejar completamente las restricciones de la red de calles \\ que implica el problema de enrutamiento de la recolección.\end{tabular} \\ \hline
(b) Basado en SIG           & \textit{Fortalezas}                                                                                                                                                            \\
                            & \begin{tabular}[c]{@{}c@{}}(1) Permite la incorporación de impedancias y restricciones en el modelado \\ de red de rutas.\end{tabular}                                         \\
                            & \begin{tabular}[c]{@{}c@{}}(2) Muestra espacialmente resultados de optimización que pueden entenderse \\ y apreciarse fácilmente.\end{tabular}                                 \\
                            & \begin{tabular}[c]{@{}c@{}}(3) Permite la incorporación de características de relieve en el modelado \\ de red de calles.\end{tabular}                                         \\
                            & (4) Mejora la eficiencia de la recolección de residuos.                                                                                                                        \\
                            & (5) Usado como herramienta de soporte de decisión.                                                                                                                             \\
                            & \textit{Debilidades}                                                                                                                                                           \\
                            & \begin{tabular}[c]{@{}c@{}}(1) Dificultad para incorporar la consideración de la contaminación ambiental \\ en el modelado de red de calles.\end{tabular}                      \\
\multicolumn{1}{c}{}        & \begin{tabular}[c]{@{}c@{}}(2) El solucionador de VRP no es ideal para calcular la optimización de rutas \\ para un gran conjunto de puntos.\end{tabular}                      \\ \hline
\end{tabular}%
}
\end{table}
...
% Se reveló que las rutas óptimas pueden no ser necesariamente la distancia más corta desde el punto A al punto B, considerando la congestión del tráfico y la presencia de muchos semáforos en distancias cortas.
...
% Este modelo sirvió de base para la implementación presentada en este trabajo.
...
% retribuir en parte al Estado los beneficios y conocimientos que hemos adquirido a través de nuestra carrera en la Universidad.
